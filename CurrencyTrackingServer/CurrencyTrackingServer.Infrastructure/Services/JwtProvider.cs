...
using CurrencyTrackingServer.Application.Services;
using CurrencyTrackingServer.Domain.Entities;
using CurrencyTrackingServer.Infrastructure.Options;
...
namespace CurrencyTrackingServer.Infrastructure.Services;
